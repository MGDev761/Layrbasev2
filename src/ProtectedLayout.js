...
const ProtectedLayout = () => {
  ...
  const tabs = [
    ...
    { id: 'captable', name: 'Cap Table', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
    ...
    { id: 'tasks', name: 'Task Manager', icon: 'M9 5H7a2 2 0 00-2 2v6a2 2 0 002 2h2m2 0h2a2 2 0 002-2V7a2 2 0 00-2-2h-2m0 0V3a2 2 0 10-4 0v2m4 0a2 2 0 104 0v2m-6 8a2 2 0 100-4 2 2 0 000 4z' },
  ];
