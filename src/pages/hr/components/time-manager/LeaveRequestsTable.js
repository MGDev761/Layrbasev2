...
const LeaveRequestsTable = ({ orgId, userId, currentUser }) => {
  ...
  return (
    <div>
      {/* Actions Bar - visually attached to table */}
      ...
      <div className="bg-white rounded-b-md overflow-visible min-h-[180px]">
        {error && (
          <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-md text-sm m-4">
            {error}
          </div>
        )}
